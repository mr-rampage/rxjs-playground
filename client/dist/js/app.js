...
var _rx = require("rx/dist/rx.all");
...
var secondStream = _rx2.default.Observable.interval(1000);
secondStream.subscribe(function () {
  counter.count++;
});

var counterStream = _rx2.default.Observable.ofObjectChanges(counter);

var renderer = _rx2.default.Observer.create(function (e) {
...
},{"rx/dist/rx.all":3,"virtual-dom/create-element":4,"virtual-dom/diff":5,"virtual-dom/h":6,"virtual-dom/patch":14}],38:[function(require,module,exports){
